//
//  StocksTableTableViewController.m
//  StocksApp
//
...
#import "StocksTableTableViewController.h"
#import "Stock.h"

@interface StocksTableTableViewController ()

@end

@implementation StocksTableTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    Stock *stock = [[Stock alloc]init];
    stock.stockTitle = @"APPL";
